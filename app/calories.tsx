...
export default function CaloriesScreen() {
  ...
  const [mode, setMode] = useState<'home' | 'voice' | 'result'>('home');
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 16, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: colors.border }}>
        ...
        <Text style={{ flex: 1, fontSize: 18, fontWeight: '900', color: '#fff' }}>🔥 Calorie Tracker</Text>
      </View>
      ...
      {loading ? (
        ...
        <ScrollView contentContainerStyle={{ padding: 16, gap: 14 }}>
          ...
          <Pressable onPress={() => { setMode('home'); setResult(null); setVoiceText(''); }}
        ...
        <View style={{ flex: 1, padding: 16 }}>
          ...
          <Text style={{ fontSize: 13, color: colors.gray, marginBottom: 16 }}>Type or speak what you ate — e.g. "2 rotis with dal and a glass of lassi"</Text>
          <TextInput
            value={voiceText}
            ...
            multiline
            style={{ backgroundColor: colors.card2, borderRadius: 14, padding: 16, color: '#fff', fontSize: 14, borderWidth: 1, borderColor: colors.border, minHeight: 120, textAlignVertical: 'top', marginBottom: 16 }}
          />
        ...
        <ScrollView contentContainerStyle={{ padding: 16, gap: 14 }}>
          <Text style={{ fontSize: 15, color: colors.gray, lineHeight: 22 }}>
            Track calories instantly — snap a photo of your meal or describe it in your own words.
          </Text>
          ...
          <Pressable onPress={() => setMode('voice')}
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={{ fontSize: 13, color: colors.gray, marginTop: 2 }}>Type or voice what you ate</Text>
            </View>
            <Text style={{ color: colors.orange, fontSize: 18 }}>→</Text>
          </Pressable>
          ...
          <View style={{ backgroundColor: colors.card, borderRadius: 18, padding: 16, borderWidth: 1, borderColor: colors.border }}>
            <Text style={{ fontSize: 14, fontWeight: '800', color: '#fff', marginBottom: 12 }}>Today's Log</Text>
            <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
              {[
